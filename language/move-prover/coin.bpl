...
procedure {:inline 1} $Vector_singleton_def($tv0: $TypeValue, e: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(16, 1206, 0, e); }
    ...
    call $tmp := $CopyOrMoveValue($t2);
    v := $tmp;
    if (true) { assume $DebugTrackLocal(16, 1279, 1, $tmp); }
    ...
    // return v
    $ret0 := v;
    if (true) { assume $DebugTrackLocal(16, 1330, 8, $ret0); }
    return;
...
procedure {:inline 1} $LibraTimestamp_assert_is_genesis_def() returns (){
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 3650);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t2);
    $t0 := $tmp;
    if (true) { assume $DebugTrackLocal(11, 4119, 0, $tmp); }
...
L1:
    ...
    // abort($t4)
    if (true) { assume $DebugTrackAbort(11, 4119); }
    goto Abort;
...
procedure {:inline 1} $LibraTimestamp_initialize_def(association: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(11, 1066, 0, association); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 1211);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 1253);
      goto Abort;
    }
    ...
    $t2 := $tmp;
    if (true) { assume $DebugTrackLocal(11, 1196, 2, $tmp); }
...
L1:
    ...
    // abort($t10)
    if (true) { assume $DebugTrackAbort(11, 1196); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 1424);
      goto Abort;
    }
...
procedure {:inline 1} $LibraTimestamp_is_genesis_def() returns ($ret0: $Value){
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 3718);
      goto Abort;
    }
    ...
    // return $t2
    $ret0 := $t2;
    if (true) { assume $DebugTrackLocal(11, 3679, 3, $ret0); }
    return;
...
procedure {:inline 1} $LibraTimestamp_is_not_initialized_def() returns ($ret0: $Value){
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 3962);
      goto Abort;
    }
...
L0:
    ...
    call $tmp := $CopyOrMoveValue($t4);
    $t0 := $tmp;
    if (true) { assume $DebugTrackLocal(11, 3914, 0, $tmp); }
...
L2:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 3396);
      goto Abort;
    }
...
L3:
    ...
    // return $t0
    $ret0 := $t0;
    if (true) { assume $DebugTrackLocal(11, 3914, 9, $ret0); }
    return;
...
procedure {:inline 1} $LibraTimestamp_now_microseconds_def() returns ($ret0: $Value){
    ...
    call $t0 := $CoreAddresses_LIBRA_ROOT_ADDRESS();
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 3517);
      goto Abort;
    }
    assume is#$Address($t0);
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 3463);
      goto Abort;
    }
    ...
    // return $t3
    $ret0 := $t3;
    if (true) { assume $DebugTrackLocal(11, 3463, 4, $ret0); }
    return;
...
procedure {:inline 1} $LibraTimestamp_reset_time_has_started_for_test_def() returns (){
    ...
    call $t0 := $CoreAddresses_LIBRA_ROOT_ADDRESS();
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 2365);
      goto Abort;
    }
    assume is#$Address($t0);
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 2324);
      goto Abort;
    }
...
procedure {:inline 1} $LibraTimestamp_set_time_has_started_def(association: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(11, 1564, 0, association); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 1676);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 1718);
      goto Abort;
    }
    ...
    $t1 := $tmp;
    if (true) { assume $DebugTrackLocal(11, 1661, 1, $tmp); }
...
L1:
    ...
    // abort($t12)
    if (true) { assume $DebugTrackAbort(11, 1661); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 1872);
      goto Abort;
    }
...
L2:
    ...
    $t5 := $tmp;
    if (true) { assume $DebugTrackLocal(11, 1825, 5, $tmp); }
...
L5:
    ...
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(11, 1805, 3, $tmp); }
...
L7:
    ...
    // abort($t22)
    if (true) { assume $DebugTrackAbort(11, 1805); }
    goto Abort;
...
L6:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 1955);
      goto Abort;
    }
...
procedure {:inline 1} $LibraTimestamp_update_global_time_def(account: $Value, proposer: $Value, timestamp: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(11, 2514, 0, account); }
    if (true) { assume $DebugTrackLocal(11, 2514, 1, proposer); }
    if (true) { assume $DebugTrackLocal(11, 2514, 2, timestamp); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 2738);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 2776);
      goto Abort;
    }
    ...
    $t4 := $tmp;
    if (true) { assume $DebugTrackLocal(11, 2723, 4, $tmp); }
...
L1:
    ...
    // abort($t15)
    if (true) { assume $DebugTrackAbort(11, 2723); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 2890);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 2832);
      goto Abort;
    }
    ...
    if (true) { assume $DebugTrackLocal(11, 2817, 3, $Dereference(global_timer)); }

    // $t19 := CoreAddresses::VM_RESERVED_ADDRESS()
    call $t19 := $CoreAddresses_VM_RESERVED_ADDRESS();
    if ($abort_flag) {
      assume $DebugTrackAbort(11, 2952);
      goto Abort;
    }
...
L2:
    ...
    $t6 := $tmp;
    if (true) { assume $DebugTrackLocal(11, 3070, 6, $tmp); }
...
L6:
    ...
    // abort($t28)
    if (true) { assume $DebugTrackAbort(11, 3070); }
    goto Abort;
...
L4:
    ...
    $t8 := $tmp;
    if (true) { assume $DebugTrackLocal(11, 3200, 8, $tmp); }
...
L8:
    ...
    // abort($t36)
    if (true) { assume $DebugTrackAbort(11, 3200); }
    goto Abort;
...
L7:
    ...
    if (true) { assume $DebugTrackLocal(11, 3272, 3, $Dereference(global_timer)); }
...
procedure {:inline 1} $Roles_CHILD_VASP_ROLE_ID_def() returns ($ret0: $Value){
    ...
    // return $t0
    $ret0 := $t0;
    if (true) { assume $DebugTrackLocal(14, 1193, 1, $ret0); }
    return;
...
procedure {:inline 1} $Roles_DESIGNATED_DEALER_ROLE_ID_def() returns ($ret0: $Value){
    ...
    // return $t0
    $ret0 := $t0;
    if (true) { assume $DebugTrackLocal(14, 1025, 1, $ret0); }
    return;
...
procedure {:inline 1} $Roles_LIBRA_ROOT_ROLE_ID_def() returns ($ret0: $Value){
    ...
    // return $t0
    $ret0 := $t0;
    if (true) { assume $DebugTrackLocal(14, 929, 1, $ret0); }
    return;
...
procedure {:inline 1} $Roles_PARENT_VASP_ROLE_ID_def() returns ($ret0: $Value){
    ...
    // return $t0
    $ret0 := $t0;
    if (true) { assume $DebugTrackLocal(14, 1153, 1, $ret0); }
    return;
...
procedure {:inline 1} $Roles_TREASURY_COMPLIANCE_ROLE_ID_def() returns ($ret0: $Value){
    ...
    // return $t0
    $ret0 := $t0;
    if (true) { assume $DebugTrackLocal(14, 978, 1, $ret0); }
    return;
...
procedure {:inline 1} $Roles_UNHOSTED_ROLE_ID_def() returns ($ret0: $Value){
    ...
    // return $t0
    $ret0 := $t0;
    if (true) { assume $DebugTrackLocal(14, 1231, 1, $ret0); }
    return;
...
procedure {:inline 1} $Roles_VALIDATOR_OPERATOR_ROLE_ID_def() returns ($ret0: $Value){
    ...
    // return $t0
    $ret0 := $t0;
    if (true) { assume $DebugTrackLocal(14, 1112, 1, $ret0); }
    return;
...
procedure {:inline 1} $Roles_VALIDATOR_ROLE_ID_def() returns ($ret0: $Value){
    ...
    // return $t0
    $ret0 := $t0;
    if (true) { assume $DebugTrackLocal(14, 1064, 1, $ret0); }
    return;
...
procedure {:inline 1} $Roles_add_privilege_to_account_association_root_role_def($tv0: $TypeValue, account: $Value, witness: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 2385, 0, account); }
    if (true) { assume $DebugTrackLocal(14, 2385, 1, witness); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 2571);
      goto Abort;
    }
    assume is#$Address($t6);
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 2541);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t7);
    account_role := $tmp;
    if (true) { assume $DebugTrackLocal(14, 2526, 2, $tmp); }
    ...
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 2601, 3, $tmp); }
...
L1:
    ...
    // abort($t15)
    if (true) { assume $DebugTrackAbort(14, 2601); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 2666);
      goto Abort;
    }
...
procedure {:inline 1} $Roles_grant_root_association_role_def(association: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 3191, 0, association); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 3293);
      goto Abort;
    }
    ...
    call $t5 := $Signer_address_of($t4);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 3350);
      goto Abort;
    }
    assume is#$Address($t5);
    ...
    $t2 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 3383, 2, $tmp); }
...
L1:
    ...
    // abort($t11)
    if (true) { assume $DebugTrackAbort(14, 3383); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 3514);
      goto Abort;
    }
...
procedure {:inline 1} $Roles_grant_treasury_compliance_role_def(treasury_compliance_account: $Value, lr_account: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 3758, 0, treasury_compliance_account); }
    if (true) { assume $DebugTrackLocal(14, 3758, 1, lr_account); }
    ...
    call $LibraTimestamp_assert_is_genesis();
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 3924);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 8974);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t8);
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 3953, 3, $tmp); }
...
L1:
    ...
    // abort($t11)
    if (true) { assume $DebugTrackAbort(14, 3953); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 4035);
      goto Abort;
    }
    assume is#$Address($t13);
    ...
    $t5 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 4084, 5, $tmp); }
...
L3:
    ...
    // abort($t19)
    if (true) { assume $DebugTrackAbort(14, 4084); }
    goto Abort;
...
L2:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 4230);
      goto Abort;
    }
...
procedure {:inline 1} $Roles_has_child_VASP_role_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 9803, 0, account); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 1165);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 8751);
      goto Abort;
    }
    ...
    // return $t3
    $ret0 := $t3;
    if (true) { assume $DebugTrackLocal(14, 9884, 5, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_designated_dealer_role_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 9245, 0, account); }
    ...
    // return $t3
    $ret0 := $t3;
    if (true) { assume $DebugTrackLocal(14, 9333, 5, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_libra_root_role_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 8963, 0, account); }
    ...
    // return $t3
    $ret0 := $t3;
    if (true) { assume $DebugTrackLocal(14, 9044, 5, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_on_chain_config_privilege_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 10369, 0, account); }
    ...
    // return $t2
    $ret0 := $t2;
    if (true) { assume $DebugTrackLocal(14, 10461, 4, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_parent_VASP_role_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 9669, 0, account); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 1124);
      goto Abort;
    }
    assume $IsValidU64($t2);
    ...
    // return $t3
    $ret0 := $t3;
    if (true) { assume $DebugTrackLocal(14, 9751, 5, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_register_new_currency_privilege_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 10063, 0, account); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 9106);
      goto Abort;
    }
    assume is#$Boolean($t2);
    ...
    // return $t2
    $ret0 := $t2;
    if (true) { assume $DebugTrackLocal(14, 10161, 4, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_role_def(account: $Value, role_id: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 8740, 0, account); }
    if (true) { assume $DebugTrackLocal(14, 8740, 1, role_id); }
    ...
    call $t5 := $Signer_address_of($t4);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 8842);
      goto Abort;
    }
    assume is#$Address($t5);
    ...
    call $tmp := $CopyOrMoveValue($t5);
    addr := $tmp;
    if (true) { assume $DebugTrackLocal(14, 8827, 2, $tmp); }
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 8905);
      goto Abort;
    }
    assume $Roles_RoleId_is_well_formed($tmp);
    $t9 := $tmp;
    ...
    call $tmp := $CopyOrMoveValue($t13);
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 8870, 3, $tmp); }
...
L3:
    ...
    // return $t3
    $ret0 := $t3;
    if (true) { assume $DebugTrackLocal(14, 8870, 18, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_treasury_compliance_role_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 9095, 0, account); }
    ...
    // return $t3
    $ret0 := $t3;
    if (true) { assume $DebugTrackLocal(14, 9185, 5, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_unhosted_role_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 9935, 0, account); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 1205);
      goto Abort;
    }
    assume $IsValidU64($t2);
    ...
    // return $t3
    $ret0 := $t3;
    if (true) { assume $DebugTrackLocal(14, 10014, 5, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_update_dual_attestation_threshold_privilege_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 10210, 0, account); }
    ...
    // return $t2
    $ret0 := $t2;
    if (true) { assume $DebugTrackLocal(14, 10320, 4, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_validator_operator_role_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 9521, 0, account); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 1076);
      goto Abort;
    }
    assume $IsValidU64($t2);
    ...
    // return $t3
    $ret0 := $t3;
    if (true) { assume $DebugTrackLocal(14, 9610, 5, $ret0); }
    return;
...
procedure {:inline 1} $Roles_has_validator_role_def(account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 9391, 0, account); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 1037);
      goto Abort;
    }
    assume $IsValidU64($t2);
    ...
    // return $t3
    $ret0 := $t3;
    if (true) { assume $DebugTrackLocal(14, 9471, 5, $ret0); }
    return;
...
procedure {:inline 1} $Roles_new_child_vasp_role_def(creating_account: $Value, new_account: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 7135, 0, creating_account); }
    if (true) { assume $DebugTrackLocal(14, 7135, 1, new_account); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 7313);
      goto Abort;
    }
    assume is#$Address($t8);
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 7283);
      goto Abort;
    }
    assume $Roles_RoleId_is_well_formed($tmp);
    $t9 := $tmp;
    ...
    call $tmp := $CopyOrMoveValue($t9);
    calling_role := $tmp;
    if (true) { assume $DebugTrackLocal(14, 7268, 2, $tmp); }
    ...
    call $t11 := $Signer_address_of($t10);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 7456);
      goto Abort;
    }
    assume is#$Address($t11);
    ...
    call $tmp := $CopyOrMoveValue($t13);
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 7425, 3, $tmp); }
...
L1:
    ...
    // abort($t17)
    if (true) { assume $DebugTrackAbort(14, 7425); }
    goto Abort;
...
L0:
    ...
    $t5 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 7494, 5, $tmp); }
...
L3:
    ...
    // abort($t25)
    if (true) { assume $DebugTrackAbort(14, 7494); }
    goto Abort;
...
L2:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 7560);
      goto Abort;
    }
...
procedure {:inline 1} $Roles_new_designated_dealer_role_def(creating_account: $Value, new_account: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 4652, 0, creating_account); }
    if (true) { assume $DebugTrackLocal(14, 4652, 1, new_account); }
    ...
    call $t8 := $Signer_address_of($t7);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 4837);
      goto Abort;
    }
    assume is#$Address($t8);
    ...
    call $tmp := $GetGlobal($t8, $Roles_RoleId_type_value());
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 4807);
      goto Abort;
    }
    assume $Roles_RoleId_is_well_formed($tmp);
    $t9 := $tmp;
    ...
    call $tmp := $CopyOrMoveValue($t9);
    calling_role := $tmp;
    if (true) { assume $DebugTrackLocal(14, 4792, 2, $tmp); }
    ...
    call $t11 := $Signer_address_of($t10);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 4980);
      goto Abort;
    }
    assume is#$Address($t11);
    ...
    call $tmp := $CopyOrMoveValue($t13);
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 4949, 3, $tmp); }
...
L1:
    ...
    // abort($t17)
    if (true) { assume $DebugTrackAbort(14, 4949); }
    goto Abort;
...
L0:
    ...
    call $tmp := $CopyOrMoveValue($t22);
    $t5 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 5018, 5, $tmp); }
...
L3:
    ...
    // abort($t25)
    if (true) { assume $DebugTrackAbort(14, 5018); }
    goto Abort;
...
L2:
    ...
    call $MoveTo($Roles_RoleId_type_value(), $t28, $t26);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 5092);
      goto Abort;
    }
...
procedure {:inline 1} $Roles_new_parent_vasp_role_def(creating_account: $Value, new_account: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 6524, 0, creating_account); }
    if (true) { assume $DebugTrackLocal(14, 6524, 1, new_account); }
    ...
    call $t8 := $Signer_address_of($t7);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 6703);
      goto Abort;
    }
    assume is#$Address($t8);
    ...
    call $tmp := $GetGlobal($t8, $Roles_RoleId_type_value());
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 6673);
      goto Abort;
    }
    assume $Roles_RoleId_is_well_formed($tmp);
    $t9 := $tmp;
    ...
    call $tmp := $CopyOrMoveValue($t9);
    calling_role := $tmp;
    if (true) { assume $DebugTrackLocal(14, 6658, 2, $tmp); }
    ...
    call $t11 := $Signer_address_of($t10);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 6846);
      goto Abort;
    }
    assume is#$Address($t11);
    ...
    call $tmp := $CopyOrMoveValue($t13);
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 6815, 3, $tmp); }
...
L1:
    ...
    // abort($t17)
    if (true) { assume $DebugTrackAbort(14, 6815); }
    goto Abort;
...
L0:
    ...
    call $tmp := $CopyOrMoveValue($t22);
    $t5 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 6884, 5, $tmp); }
...
L3:
    ...
    // abort($t25)
    if (true) { assume $DebugTrackAbort(14, 6884); }
    goto Abort;
...
L2:
    ...
    call $MoveTo($Roles_RoleId_type_value(), $t28, $t26);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 6949);
      goto Abort;
    }
...
procedure {:inline 1} $Roles_new_unhosted_role_def(_creating_account: $Value, new_account: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 7789, 0, _creating_account); }
    if (true) { assume $DebugTrackLocal(14, 7789, 1, new_account); }
    ...
    call $t5 := $Signer_address_of($t4);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 7982);
      goto Abort;
    }
    assume is#$Address($t5);
    ...
    call $tmp := $CopyOrMoveValue($t7);
    $t2 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 7951, 2, $tmp); }
...
L1:
    ...
    // abort($t10)
    if (true) { assume $DebugTrackAbort(14, 7951); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 8020);
      goto Abort;
    }
...
procedure {:inline 1} $Roles_new_validator_operator_role_def(creating_account: $Value, new_account: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 5892, 0, creating_account); }
    if (true) { assume $DebugTrackLocal(14, 5892, 1, new_account); }
    ...
    call $t8 := $Signer_address_of($t7);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 6078);
      goto Abort;
    }
    assume is#$Address($t8);
    ...
    call $tmp := $GetGlobal($t8, $Roles_RoleId_type_value());
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 6048);
      goto Abort;
    }
    assume $Roles_RoleId_is_well_formed($tmp);
    $t9 := $tmp;
    ...
    call $tmp := $CopyOrMoveValue($t9);
    calling_role := $tmp;
    if (true) { assume $DebugTrackLocal(14, 6033, 2, $tmp); }
    ...
    call $t11 := $Signer_address_of($t10);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 6221);
      goto Abort;
    }
    assume is#$Address($t11);
    ...
    call $tmp := $CopyOrMoveValue($t13);
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 6190, 3, $tmp); }
...
L1:
    ...
    // abort($t17)
    if (true) { assume $DebugTrackAbort(14, 6190); }
    goto Abort;
...
L0:
    ...
    call $tmp := $CopyOrMoveValue($t22);
    $t5 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 6259, 5, $tmp); }
...
L3:
    ...
    // abort($t25)
    if (true) { assume $DebugTrackAbort(14, 6259); }
    goto Abort;
...
L2:
    ...
    call $MoveTo($Roles_RoleId_type_value(), $t28, $t26);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 6324);
      goto Abort;
    }
...
procedure {:inline 1} $Roles_new_validator_role_def(creating_account: $Value, new_account: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(14, 5281, 0, creating_account); }
    if (true) { assume $DebugTrackLocal(14, 5281, 1, new_account); }
    ...
    call $t8 := $Signer_address_of($t7);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 5457);
      goto Abort;
    }
    assume is#$Address($t8);
    ...
    call $tmp := $GetGlobal($t8, $Roles_RoleId_type_value());
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 5427);
      goto Abort;
    }
    assume $Roles_RoleId_is_well_formed($tmp);
    $t9 := $tmp;
    ...
    call $tmp := $CopyOrMoveValue($t9);
    calling_role := $tmp;
    if (true) { assume $DebugTrackLocal(14, 5412, 2, $tmp); }
    ...
    call $t11 := $Signer_address_of($t10);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 5600);
      goto Abort;
    }
    assume is#$Address($t11);
    ...
    call $tmp := $CopyOrMoveValue($t13);
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 5569, 3, $tmp); }
...
L1:
    ...
    // abort($t17)
    if (true) { assume $DebugTrackAbort(14, 5569); }
    goto Abort;
...
L0:
    ...
    call $tmp := $CopyOrMoveValue($t22);
    $t5 := $tmp;
    if (true) { assume $DebugTrackLocal(14, 5638, 5, $tmp); }
...
L3:
    ...
    // abort($t25)
    if (true) { assume $DebugTrackAbort(14, 5638); }
    goto Abort;
...
L2:
    ...
    call $MoveTo($Roles_RoleId_type_value(), $t28, $t26);
    if ($abort_flag) {
      assume $DebugTrackAbort(14, 5703);
      goto Abort;
    }
...
procedure {:inline 1} $Offer_address_of_def($tv0: $TypeValue, offer_address: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(12, 1473, 0, offer_address); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(12, 1558);
      goto Abort;
    }
    ...
    // return $t4
    $ret0 := $t4;
    if (true) { assume $DebugTrackLocal(12, 1558, 6, $ret0); }
    return;
...
procedure {:inline 1} $Offer_create_def($tv0: $TypeValue, account: $Value, offered: $Value, for: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(12, 459, 0, account); }
    if (true) { assume $DebugTrackLocal(12, 459, 1, offered); }
    if (true) { assume $DebugTrackLocal(12, 459, 2, for); }
...
procedure {:inline 1} $Offer_exists_at_def($tv0: $TypeValue, offer_address: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(12, 1251, 0, offer_address); }
    ...
    // return $t2
    $ret0 := $t2;
    if (true) { assume $DebugTrackLocal(12, 1317, 4, $ret0); }
    return;
...
procedure {:inline 1} $Offer_redeem_def($tv0: $TypeValue, account: $Value, offer_address: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(12, 833, 0, account); }
    if (true) { assume $DebugTrackLocal(12, 833, 1, offer_address); }
    ...
    for := $tmp;
    if (true) { assume $DebugTrackLocal(12, 962, 2, $tmp); }

    // offered := $t10
    call $tmp := $CopyOrMoveValue($t10);
    offered := $tmp;
    if (true) { assume $DebugTrackLocal(12, 953, 3, $tmp); }
    ...
    call $t13 := $Signer_address_of($t12);
    if ($abort_flag) {
      assume $DebugTrackAbort(12, 1037);
      goto Abort;
    }
    assume is#$Address($t13);
    ...
    call $tmp := $CopyOrMoveValue($t13);
    sender := $tmp;
    if (true) { assume $DebugTrackLocal(12, 1020, 4, $tmp); }
...
L0:
    ...
    call $tmp := $CopyOrMoveValue($t17);
    $t7 := $tmp;
    if (true) { assume $DebugTrackLocal(12, 1110, 7, $tmp); }
...
L3:
    ...
    call $tmp := $CopyOrMoveValue($t7);
    $t5 := $tmp;
    if (true) { assume $DebugTrackLocal(12, 1103, 5, $tmp); }
...
L5:
    ...
    // abort($t23)
    if (true) { assume $DebugTrackAbort(12, 1103); }
    goto Abort;
...
L4:
    ...
    // return offered
    $ret0 := offered;
    if (true) { assume $DebugTrackLocal(12, 1161, 27, $ret0); }
    return;
...
procedure {:inline 1} $LibraConfig_initialize_def(config_account: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(10, 888, 0, config_account); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 1009);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 1054);
      goto Abort;
    }
    assume is#$Address($t5);
    ...
    $t1 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 994, 1, $tmp); }
...
L1:
    ...
    // abort($t9)
    if (true) { assume $DebugTrackAbort(10, 994); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 1271);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 1088);
      goto Abort;
    }
...
procedure {:inline 1} $LibraConfig_claim_delegated_modify_config_def($tv0: $TypeValue, account: $Value, offer_address: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(10, 5931, 0, account); }
    if (true) { assume $DebugTrackLocal(10, 5931, 1, offer_address); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 6056);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 6032);
      goto Abort;
    }
...
procedure {:inline 1} $LibraConfig_emit_reconfiguration_event_def() returns (){
    ...
    call $t1 := $CoreAddresses_LIBRA_ROOT_ADDRESS();
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 8233);
      goto Abort;
    }
    assume is#$Address($t1);
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 8185);
      goto Abort;
    }
    ...
    if (true) { assume $DebugTrackLocal(10, 8172, 0, $Dereference(config_ref)); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 8300);
      goto Abort;
    }
    $t7 := $tmp;
    ...
    if (true) { assume $DebugTrackLocal(10, 8264, 0, $Dereference(config_ref)); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 8321);
      goto Abort;
    }
    ...
    if (true) { assume $DebugTrackLocal(10, 8102, 0, $Dereference(config_ref)); }
...
procedure {:inline 1} $LibraConfig_get_def($tv0: $TypeValue) returns ($ret0: $Value){
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 1513);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t3);
    addr := $tmp;
    if (true) { assume $DebugTrackLocal(10, 1491, 0, $tmp); }
    ...
    call $tmp := $CopyOrMoveValue($t5);
    $t1 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 1543, 1, $tmp); }
...
L1:
    ...
    // abort($t7)
    if (true) { assume $DebugTrackAbort(10, 1543); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 1600);
      goto Abort;
    }
    ...
    // return $t11
    $ret0 := $t11;
    if (true) { assume $DebugTrackLocal(10, 1598, 12, $ret0); }
    return;
...
procedure {:inline 1} $LibraConfig_publish_new_config_def($tv0: $TypeValue, config_account: $Value, payload: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(10, 4226, 0, config_account); }
    if (true) { assume $DebugTrackLocal(10, 4226, 1, payload); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 4390);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t7);
    $t2 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 4376, 2, $tmp); }
...
L1:
    ...
    // abort($t10)
    if (true) { assume $DebugTrackAbort(10, 4376); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 4469);
      goto Abort;
    }
    assume is#$Address($t12);
    ...
    call $t13 := $CoreAddresses_LIBRA_ROOT_ADDRESS();
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 4514);
      goto Abort;
    }
    assume is#$Address($t13);
    ...
    call $tmp := $CopyOrMoveValue($t14);
    $t4 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 4454, 4, $tmp); }
...
L3:
    ...
    // abort($t17)
    if (true) { assume $DebugTrackAbort(10, 4454); }
    goto Abort;
...
L2:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 4548);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 4616);
      goto Abort;
    }
...
procedure {:inline 1} $LibraConfig_publish_new_config_with_capability_def($tv0: $TypeValue, config_account: $Value, payload: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(10, 2931, 0, config_account); }
    if (true) { assume $DebugTrackLocal(10, 2931, 1, payload); }
    ...
    call $t7 := $Roles_has_on_chain_config_privilege($t6);
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 3144);
      goto Abort;
    }
    assume is#$Boolean($t7);
    ...
    call $tmp := $CopyOrMoveValue($t7);
    $t2 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 3130, 2, $tmp); }
...
L1:
    ...
    // abort($t10)
    if (true) { assume $DebugTrackAbort(10, 3130); }
    goto Abort;
...
L0:
    ...
    call $t12 := $Signer_address_of($t11);
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 3223);
      goto Abort;
    }
    assume is#$Address($t12);
    ...
    call $t13 := $CoreAddresses_LIBRA_ROOT_ADDRESS();
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 3268);
      goto Abort;
    }
    assume is#$Address($t13);
    ...
    call $tmp := $CopyOrMoveValue($t14);
    $t4 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 3208, 4, $tmp); }
...
L3:
    ...
    // abort($t17)
    if (true) { assume $DebugTrackAbort(10, 3208); }
    goto Abort;
...
L2:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 3302);
      goto Abort;
    }
    ...
    // return $t22
    $ret0 := $t22;
    if (true) { assume $DebugTrackLocal(10, 3628, 25, $ret0); }
    return;
...
procedure {:inline 1} $LibraConfig_publish_new_config_with_delegate_def($tv0: $TypeValue, config_account: $Value, payload: $Value, delegate: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(10, 5060, 0, config_account); }
    if (true) { assume $DebugTrackLocal(10, 5060, 1, payload); }
    if (true) { assume $DebugTrackLocal(10, 5060, 2, delegate); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 5266);
      goto Abort;
    }
    assume is#$Boolean($t8);
    ...
    call $tmp := $CopyOrMoveValue($t8);
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 5252, 3, $tmp); }
...
L1:
    ...
    // abort($t11)
    if (true) { assume $DebugTrackAbort(10, 5252); }
    goto Abort;
...
L0:
    ...
    call $t13 := $Signer_address_of($t12);
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 5345);
      goto Abort;
    }
    assume is#$Address($t13);
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 5390);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t15);
    $t5 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 5330, 5, $tmp); }
...
L3:
    ...
    // abort($t18)
    if (true) { assume $DebugTrackAbort(10, 5330); }
    goto Abort;
...
L2:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 5431);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 5507);
      goto Abort;
    }
...
procedure {:inline 1} $LibraConfig_publish_new_treasury_compliance_config_def($tv0: $TypeValue, config_account: $Value, tc_account: $Value, payload: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(10, 3741, 0, config_account); }
    if (true) { assume $DebugTrackLocal(10, 3741, 1, tc_account); }
    if (true) { assume $DebugTrackLocal(10, 3741, 2, payload); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 3955);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t6);
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 3941, 3, $tmp); }
...
L1:
    ...
    // abort($t10)
    if (true) { assume $DebugTrackAbort(10, 3941); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 4019);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 4077);
      goto Abort;
    }
...
procedure {:inline 1} $LibraConfig_reconfigure_def(lr_account: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(10, 6131, 0, lr_account); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 6338);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t4);
    $t1 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 6324, 1, $tmp); }
...
L1:
    ...
    // abort($t6)
    if (true) { assume $DebugTrackAbort(10, 6324); }
    goto Abort;
...
procedure {:inline 1} $LibraConfig_reconfigure__def() returns (){
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 6589);
      goto Abort;
    }
    assume is#$Boolean($t4);
...
L2:
    ...
    call $t5 := $CoreAddresses_LIBRA_ROOT_ADDRESS();
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 6717);
      goto Abort;
    }
    assume is#$Address($t5);
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 6669);
      goto Abort;
    }
    ...
    if (true) { assume $DebugTrackLocal(10, 6656, 0, $Dereference(config_ref)); }

    // $t7 := LibraTimestamp::now_microseconds()
    call $t7 := $LibraTimestamp_now_microseconds();
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 6991);
      goto Abort;
    }
    ...
    if (true) { assume $DebugTrackLocal(10, 6954, 1, $tmp); }
    ...
    call $tmp := $CopyOrMoveValue($t12);
    $t2 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 7018, 2, $tmp); }
...
L4:
    ...
    // abort($t15)
    if (true) { assume $DebugTrackAbort(10, 7018); }
    goto Abort;
...
L3:
    ...
    if (true) { assume $DebugTrackLocal(10, 7096, 0, $Dereference(config_ref)); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 8106);
      goto Abort;
    }
...
procedure {:inline 1} $LibraConfig_set_def($tv0: $TypeValue, account: $Value, payload: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(10, 1794, 0, account); }
    if (true) { assume $DebugTrackLocal(10, 1794, 1, payload); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 1934);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t9);
    addr := $tmp;
    if (true) { assume $DebugTrackLocal(10, 1912, 2, $tmp); }
    ...
    call $tmp := $CopyOrMoveValue($t11);
    $t5 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 1964, 5, $tmp); }
...
L1:
    ...
    // abort($t14)
    if (true) { assume $DebugTrackAbort(10, 1964); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 2048);
      goto Abort;
    }
    assume is#$Address($t16);
    ...
    call $tmp := $CopyOrMoveValue($t16);
    signer_address := $tmp;
    if (true) { assume $DebugTrackLocal(10, 2023, 4, $tmp); }
    ...
    call $tmp := $CopyOrMoveValue($t18);
    $t7 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 2077, 7, $tmp); }
...
L3:
    ...
    // abort($t20)
    if (true) { assume $DebugTrackAbort(10, 2077); }
    goto Abort;
...
L2:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 2167);
      goto Abort;
    }
    ...
    if (true) { assume $DebugTrackLocal(10, 2158, 3, $Dereference(config)); }
    ...
    if (true) { assume $DebugTrackLocal(10, 2221, 3, $Dereference(config)); }
...
procedure {:inline 1} $LibraConfig_set_with_capability_def($tv0: $TypeValue, _cap: $Value, payload: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(10, 2354, 0, _cap); }
    if (true) { assume $DebugTrackLocal(10, 2354, 1, payload); }
    ...
    call $t6 := $CoreAddresses_LIBRA_ROOT_ADDRESS();
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 2553);
      goto Abort;
    }
    assume is#$Address($t6);
    ...
    call $tmp := $CopyOrMoveValue($t6);
    addr := $tmp;
    if (true) { assume $DebugTrackLocal(10, 2531, 2, $tmp); }
    ...
    call $tmp := $CopyOrMoveValue($t8);
    $t4 := $tmp;
    if (true) { assume $DebugTrackLocal(10, 2583, 4, $tmp); }
...
L1:
    ...
    // abort($t10)
    if (true) { assume $DebugTrackAbort(10, 2583); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(10, 2651);
      goto Abort;
    }
    ...
    if (true) { assume $DebugTrackLocal(10, 2642, 3, $Dereference(config)); }
    ...
    if (true) { assume $DebugTrackLocal(10, 2705, 3, $Dereference(config)); }
...
procedure {:inline 1} $RegisteredCurrencies_initialize_def(config_account: $Value) returns ($ret0: $Value){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(13, 820, 0, config_account); }
    ...
    call $t6 := $CoreAddresses_LIBRA_ROOT_ADDRESS();
    if ($abort_flag) {
      assume $DebugTrackAbort(13, 1019);
      goto Abort;
    }
    assume is#$Address($t6);
    ...
    call $tmp := $CopyOrMoveValue($t7);
    $t2 := $tmp;
    if (true) { assume $DebugTrackLocal(13, 946, 2, $tmp); }
...
L1:
    ...
    // abort($t10)
    if (true) { assume $DebugTrackAbort(13, 946); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(13, 1220);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(13, 1097);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t14);
    cap := $tmp;
    if (true) { assume $DebugTrackLocal(13, 1078, 1, $tmp); }
    ...
    // return $t16
    $ret0 := $t16;
    if (true) { assume $DebugTrackLocal(13, 1250, 18, $ret0); }
    return;
...
procedure {:inline 1} $RegisteredCurrencies_add_currency_code_def(currency_code: $Value, cap: $Value) returns (){
    ...
    // track values of parameters at entry time
    if (true) { assume $DebugTrackLocal(13, 2052, 0, currency_code); }
    if (true) { assume $DebugTrackLocal(13, 2052, 1, cap); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(13, 2197);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t5);
    config := $tmp;
    if (true) { assume $DebugTrackLocal(13, 2175, 2, $tmp); }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(13, 2263);
      goto Abort;
    }
    ...
    call $tmp := $CopyOrMoveValue($t10);
    $t3 := $tmp;
    if (true) { assume $DebugTrackLocal(13, 2234, 3, $tmp); }
...
L1:
    ...
    // abort($t13)
    if (true) { assume $DebugTrackAbort(13, 2234); }
    goto Abort;
...
L0:
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(13, 2354);
      goto Abort;
    }
    ...
    if ($abort_flag) {
      assume $DebugTrackAbort(13, 2429);
      goto Abort;
    }
...
procedure  $Libra_value_verify($tv0: $TypeValue, coin: $Value) returns ($ret0: $Value)
free requires $Libra_Libra_is_well_formed(coin);
requires $ExistsTxnSenderAccount($m, $txn);
...
procedure  $Libra_initialize_verify(config_account: $Value) returns ()
free requires is#$Address(config_account);
requires $ExistsTxnSenderAccount($m, $txn);
{
    call $InitVerification();
...
procedure  $Libra_assert_is_currency_verify($tv0: $TypeValue) returns ()
requires $ExistsTxnSenderAccount($m, $txn);
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($Libra_sum_of_coin_values[$tv0], old($Libra_sum_of_coin_values[$tv0])))));
{
    call $InitVerification();
...
procedure  $Libra_burn_verify($tv0: $TypeValue, account: $Value, preburn_address: $Value) returns ()
free requires is#$Address(account);
free requires is#$Address(preburn_address);
requires $ExistsTxnSenderAccount($m, $txn);
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($Libra_sum_of_coin_values[$tv0], old($Libra_sum_of_coin_values[$tv0])))));
...
procedure  $Libra_burn_with_capability_verify($tv0: $TypeValue, preburn_address: $Value, capability: $Value) returns ()
free requires is#$Address(preburn_address);
free requires $Libra_BurnCapability_is_well_formed(capability);
requires $ExistsTxnSenderAccount($m, $txn);
ensures b#$Boolean(old($Boolean(!b#$Boolean($ResourceExists($m, $Libra_Preburn_type_value($tv0), preburn_address))))) ==> $abort_flag;
ensures b#$Boolean(old($Boolean(!b#$Boolean($Libra_spec_is_currency($m, $txn, $tv0))))) ==> $abort_flag;
ensures b#$Boolean(old($Boolean($IsEqual($vlen_value($SelectField($ResourceValue($m, $Libra_Preburn_type_value($tv0), preburn_address), $Libra_Preburn_requests)), $Integer(0))))) ==> $abort_flag;
ensures b#$Boolean(old((var i := $Libra_spec_currency_info($m, $txn, $tv0); $Boolean(b#$Boolean($Boolean(i#$Integer($SelectField(i, $Libra_CurrencyInfo_total_value)) < i#$Integer($SelectField($select_vector_by_value($SelectField($ResourceValue($m, $Libra_Preburn_type_value($tv0), preburn_address), $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value)))) || b#$Boolean($Boolean(i#$Integer($SelectField(i, $Libra_CurrencyInfo_preburn_value)) < i#$Integer($SelectField($select_vector_by_value($SelectField($ResourceValue($m, $Libra_Preburn_type_value($tv0), preburn_address), $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value)))))))) ==> $abort_flag;
ensures $abort_flag ==> (b#$Boolean(old(($Boolean(!b#$Boolean($ResourceExists($m, $Libra_Preburn_type_value($tv0), preburn_address))))))
    || b#$Boolean(old(($Boolean(!b#$Boolean($Libra_spec_is_currency($m, $txn, $tv0))))))
    || b#$Boolean(old(($Boolean($IsEqual($vlen_value($SelectField($ResourceValue($m, $Libra_Preburn_type_value($tv0), preburn_address), $Libra_Preburn_requests)), $Integer(0))))))
    || b#$Boolean(old(((var i := $Libra_spec_currency_info($m, $txn, $tv0); $Boolean(b#$Boolean($Boolean(i#$Integer($SelectField(i, $Libra_CurrencyInfo_total_value)) < i#$Integer($SelectField($select_vector_by_value($SelectField($ResourceValue($m, $Libra_Preburn_type_value($tv0), preburn_address), $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value)))) || b#$Boolean($Boolean(i#$Integer($SelectField(i, $Libra_CurrencyInfo_preburn_value)) < i#$Integer($SelectField($select_vector_by_value($SelectField($ResourceValue($m, $Libra_Preburn_type_value($tv0), preburn_address), $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value))))))))));
ensures !$abort_flag ==> (b#$Boolean($Vector_eq_pop_front($Libra_Libra_type_value($tv0), $SelectField($ResourceValue($m, $Libra_Preburn_type_value($tv0), preburn_address), $Libra_Preburn_requests), old($SelectField($ResourceValue($m, $Libra_Preburn_type_value($tv0), preburn_address), $Libra_Preburn_requests)))));
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_total_value), $Integer(i#$Integer(old($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_total_value))) - i#$Integer(old($SelectField($select_vector_by_value($SelectField($ResourceValue($m, $Libra_Preburn_type_value($tv0), preburn_address), $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value))))))));
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_preburn_value), $Integer(i#$Integer(old($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_preburn_value))) - i#$Integer(old($SelectField($select_vector_by_value($SelectField($ResourceValue($m, $Libra_Preburn_type_value($tv0), preburn_address), $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value))))))));
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($Libra_sum_of_coin_values[$tv0], old($Libra_sum_of_coin_values[$tv0])))));
{
    call $InitVerification();
...
procedure  $Libra_burn_with_resource_cap_verify($tv0: $TypeValue, preburn: $Value, _: $Value, _capability: $Value) returns ($ret0: $Value)
free requires $Libra_Preburn_is_well_formed(preburn);
free requires is#$Address(_);
free requires $Libra_BurnCapability_is_well_formed(_capability);
requires $ExistsTxnSenderAccount($m, $txn);
ensures b#$Boolean(old($Boolean(!b#$Boolean($Libra_spec_is_currency($m, $txn, $tv0))))) ==> $abort_flag;
ensures b#$Boolean(old($Boolean($IsEqual($vlen_value($SelectField(preburn, $Libra_Preburn_requests)), $Integer(0))))) ==> $abort_flag;
ensures b#$Boolean(old((var i := $Libra_spec_currency_info($m, $txn, $tv0); $Boolean(b#$Boolean($Boolean(i#$Integer($SelectField(i, $Libra_CurrencyInfo_total_value)) < i#$Integer($SelectField($select_vector_by_value($SelectField(preburn, $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value)))) || b#$Boolean($Boolean(i#$Integer($SelectField(i, $Libra_CurrencyInfo_preburn_value)) < i#$Integer($SelectField($select_vector_by_value($SelectField(preburn, $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value)))))))) ==> $abort_flag;
ensures $abort_flag ==> (b#$Boolean(old(($Boolean(!b#$Boolean($Libra_spec_is_currency($m, $txn, $tv0))))))
    || b#$Boolean(old(($Boolean($IsEqual($vlen_value($SelectField(preburn, $Libra_Preburn_requests)), $Integer(0))))))
    || b#$Boolean(old(((var i := $Libra_spec_currency_info($m, $txn, $tv0); $Boolean(b#$Boolean($Boolean(i#$Integer($SelectField(i, $Libra_CurrencyInfo_total_value)) < i#$Integer($SelectField($select_vector_by_value($SelectField(preburn, $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value)))) || b#$Boolean($Boolean(i#$Integer($SelectField(i, $Libra_CurrencyInfo_preburn_value)) < i#$Integer($SelectField($select_vector_by_value($SelectField(preburn, $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value))))))))));
ensures !$abort_flag ==> (b#$Boolean($Vector_eq_pop_front($Libra_Libra_type_value($tv0), $SelectField($ret0, $Libra_Preburn_requests), old($SelectField(preburn, $Libra_Preburn_requests)))));
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_total_value), $Integer(i#$Integer(old($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_total_value))) - i#$Integer(old($SelectField($select_vector_by_value($SelectField(preburn, $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value))))))));
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_preburn_value), $Integer(i#$Integer(old($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_preburn_value))) - i#$Integer(old($SelectField($select_vector_by_value($SelectField(preburn, $Libra_Preburn_requests), $Integer(0)), $Libra_Libra_value))))))));
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($Libra_sum_of_coin_values[$tv0], old($Libra_sum_of_coin_values[$tv0])))));
{
...
procedure  $Libra_deposit_verify($tv0: $TypeValue, coin: $Value, check: $Value) returns ($ret0: $Value)
free requires $Libra_Libra_is_well_formed(coin);
free requires $Libra_Libra_is_well_formed(check);
requires $ExistsTxnSenderAccount($m, $txn);
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($Libra_sum_of_coin_values[$tv0], old($Libra_sum_of_coin_values[$tv0])))));
...
procedure  $Libra_is_currency_verify($tv0: $TypeValue) returns ($ret0: $Value)
requires $ExistsTxnSenderAccount($m, $txn);
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($Libra_sum_of_coin_values[$tv0], old($Libra_sum_of_coin_values[$tv0])))));
{
    call $InitVerification();
...
procedure  $Libra_mint_verify($tv0: $TypeValue, account: $Value, value: $Value) returns ($ret0: $Value)
free requires is#$Address(account);
free requires $IsValidU64(value);
requires $ExistsTxnSenderAccount($m, $txn);
ensures b#$Boolean(old($Boolean(!b#$Boolean($ResourceExists($m, $Libra_MintCapability_type_value($tv0), $Signer_spec_address_of($m, $txn, account)))))) ==> $abort_flag;
ensures b#$Boolean(old($Boolean(!b#$Boolean($Libra_spec_is_currency($m, $txn, $tv0))))) ==> $abort_flag;
ensures b#$Boolean(old($Boolean(!b#$Boolean($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_can_mint))))) ==> $abort_flag;
ensures b#$Boolean(old($Boolean(i#$Integer($Integer(i#$Integer($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_total_value)) + i#$Integer(value))) > i#$Integer($Integer($MAX_U128))))) ==> $abort_flag;
ensures $abort_flag ==> (b#$Boolean(old(($Boolean(!b#$Boolean($ResourceExists($m, $Libra_MintCapability_type_value($tv0), $Signer_spec_address_of($m, $txn, account)))))))
    || b#$Boolean(old(($Boolean(!b#$Boolean($Libra_spec_is_currency($m, $txn, $tv0))))))
    || b#$Boolean(old(($Boolean(!b#$Boolean($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_can_mint))))))
    || b#$Boolean(old(($Boolean(i#$Integer($Integer(i#$Integer($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_total_value)) + i#$Integer(value))) > i#$Integer($Integer($MAX_U128)))))));
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_total_value), $Integer(i#$Integer(old($SelectField($Libra_spec_currency_info($m, $txn, $tv0), $Libra_CurrencyInfo_total_value))) + i#$Integer(value))))));
...
procedure  $Libra_mint_with_capability_verify($tv0: $TypeValue, value: $Value, _capability: $Value) returns ($ret0: $Value)
free requires $IsValidU64(value);
free requires $Libra_MintCapability_is_well_formed(_capability);
requires $ExistsTxnSenderAccount($m, $txn);
ensures b#$Boolean(old($Boolean(!b#$Boolean($Libra_spec_is_currency($m, $txn, $tv0))))) ==> $abort_flag;
...
procedure  $Libra_withdraw_verify($tv0: $TypeValue, coin: $Value, amount: $Value) returns ($ret0: $Value, $ret1: $Value)
free requires $Libra_Libra_is_well_formed(coin);
free requires $IsValidU64(amount);
requires $ExistsTxnSenderAccount($m, $txn);
...
procedure  $Libra_zero_verify($tv0: $TypeValue) returns ($ret0: $Value)
requires $ExistsTxnSenderAccount($m, $txn);
ensures !$abort_flag ==> (b#$Boolean($Boolean($IsEqual($Libra_sum_of_coin_values[$tv0], old($Libra_sum_of_coin_values[$tv0])))));
{
    call $InitVerification();
